...
namespace kyfly.BLL
{
	...
	/// jichu_renyuanxinxiB
	/// </summary>
    public partial class jichu_renyuanxinxiB : System.Web.UI.Page
    {
        private readonly kyfly.DAL.jichu_renyuanxinxiB dal = new kyfly.DAL.jichu_renyuanxinxiB();
        ...
        public jichu_renyuanxinxiB(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["jichu_renyuanxinxiB"] != null)
                strifofpage = Session["jichu_renyuanxinxiB"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string xingming, string shoujihao, string OpenId, string mima, string dizhi, string zhuangtai, string leibie, string quanxian, string huiyuanjibie, string peisongcishu, string beizhu)
        {
            kyfly.Model.jichu_renyuanxinxiB model = new kyfly.Model.jichu_renyuanxinxiB();
                    ...
                    model.类别 = leibie;
                    model.权限 = quanxian;
                    model.会员级别 = huiyuanjibie;
                    model.配送次数 = int.Parse(peisongcishu);
                    model.备注 = beizhu;
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(kyfly.Model.jichu_renyuanxinxiB model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string xingming, string shoujihao, string OpenId, string mima, string dizhi, string zhuangtai, string leibie, string quanxian, string huiyuanjibie, string peisongcishu, string beizhu)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(kyfly.Model.jichu_renyuanxinxiB model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public kyfly.Model.jichu_renyuanxinxiB GetModelByCache(int Id)
        {

            string CacheKey = "jichu_renyuanxinxiBModel-" + Id;
            ...
            return (kyfly.Model.jichu_renyuanxinxiB)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<kyfly.Model.jichu_renyuanxinxiB> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<kyfly.Model.jichu_renyuanxinxiB> DataTableToList(DataTable dt)
        {
            List<kyfly.Model.jichu_renyuanxinxiB> modelList = new List<kyfly.Model.jichu_renyuanxinxiB>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                kyfly.Model.jichu_renyuanxinxiB model;
