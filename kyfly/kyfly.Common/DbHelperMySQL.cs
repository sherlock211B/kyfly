...
namespace kyfly.Common
{
    ...
    public class DbHelperMySQL
    {
        ...
        public static string GetListByPageColumns_tojson(string columslist, string strWhere, string orderby, int PageSize, int PageIndex, string datatablename,int state)
        {
            ...
            if (state==1)
            {
                str = ToBYJson(ds, allcount);//?
            }
            else
            {
                str = ToJson(ds, allcount);//?
            }
        ...
        public static string ToBYJson(DataSet ds, string allcount)
        {
            DataTable dt = ds.Tables[0];
            StringBuilder jsonString = new StringBuilder();
            //
            ...
            for (int i = 0; i < drc.Count; i++)
            {
                ...
                for (int j = 0; j < dt.Columns.Count; j++)
                {
                    ...
                    string strKey = dt.Columns[j].ColumnName;
                    string s = Pinyin.ConvertEncoding(strKey, Encoding.UTF8, gb2312);
                    strKey=Pinyin.GetInitials(s, gb2312);
